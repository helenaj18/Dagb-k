    ...
    def loadCrewFromFile(self):
        ...
        for row in reader_crew:
            if row['role'] == CrewIO.PILOT:
                ...
                pilot = Pilot(row['ssn'],row['name'],row['address'],row['phonenumber'],row['email'],\
                    row['license'],row['captain/head_flight_attendant'],row['role'])
                crew_list.append(pilot)
            elif row['role'] == CrewIO.CREWMEMBER:
                crewmember = FlightAttendant(row['ssn'],row['name'],row['address'],row['phonenumber'],row['email'],\
                    row['license'],row['captain/head_flight_attendant'],row['role'])
